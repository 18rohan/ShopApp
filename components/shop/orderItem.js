...
const OrderItem = props => {
    ...
    if (DetailOrder){
        return (
            <View>
                <CardDetailItem style={styles} amount={props.amount} date ={props.date} setDetailOrder={setDetailOrder} items={props.items}/>
            </View>
        );
    }else{
        return (
            <CardItem style={styles} amount={props.amount} date={props.date} setDetailOrder={setDetailOrder} /> 
    );
}
