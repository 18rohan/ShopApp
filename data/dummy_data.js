...
export const PRODUCTS = [
    ...
    new Product('p8',['c4','c2'],'own7','Samsung S10+', 30000, 'Thriller',{uri : 'https://www.samsung.com/global/galaxy/galaxy-s10/connected-plus/images/galaxy-s10_connected-plus_kv_s10_s.png'}),
    new Product('p3',['c1','c6','c8','c3'],'own7','Coffee', 40000, 'Thriller',{uri : 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSMO7vMDdh5p7pppzPj39BKthwFgXTztVibx3fCPBsgTISwqn4V&usqp=CAU'}),
    ...
    new Product('p2',['c1','c6','c8','c3'],'own2','Ketchup', 250, 'Thriller',{uri : 'https://www.meijer.com/content/dam/meijer/product/0001/30/0000/11/0001300000115_1200.png'}),
    new Product('p5',['c1','c6','c8','c3'],'own5','Rice', 800, 'Thriller',{uri : 'https://i.pinimg.com/originals/9d/74/5f/9d745fce45889f18d2ccb6b15e68bd69.jpg'}),
    new Product('p1',['c1','c6','c8','c3'],'own1','Cereals', 540.80, 'Thriller',{uri : 'https://previews.123rf.com/images/siraphol/siraphol1606/siraphol160600154/57619256-bangkok-thailand-may-27-2016-nestle-cereal-box-isolated-on-white-background.jpg'}),
    new Product('p6',['c4','c2'],'own6','Iphone 11 Pro', 99000, 'Thriller',{uri : 'https://pngimg.com/uploads/iphone_11/iphone_11_PNG39.png'}),
    new Product('p10',['c4','c2'],'own7','Dell XPS 13', 128000, 'Thriller',{uri : 'https://specials-images.forbesimg.com/imageserve/5e443f518b6cf300071e8c94/960x0.jpg?fit=scale'}),
    new Product('p11',['c4','c2'],'own8','One Plus 8', 54000, 'Thriller',{uri : 'https://www.androidsage.com/wp-content/uploads/2020/04/OnePlus-8-Pro.jpg'}),
    new Product('p9',['c1','c6','c8','c3'],'own2','Ketchup', 250, 'Thriller',{uri : 'https://www.meijer.com/content/dam/meijer/product/0001/30/0000/11/0001300000115_1200.png'}),
];
